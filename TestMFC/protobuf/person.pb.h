...
class Person PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_email2(const std::string& value);
  void set_email2(std::string&& value);
  void set_email2(const char* value);
  void set_email2(const char* value, size_t size);
  std::string* mutable_email2();
  std::string* release_email2();
  void set_allocated_email2(std::string* email2);
  private:
  const std::string& _internal_email2() const;
  void _internal_set_email2(const std::string& value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr email2_;
...
inline void Person::clear_email2() {
  email2_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void Person::set_email2(const std::string& value) {
  _internal_set_email2(value);
  // @@protoc_insertion_point(field_set:tutorial.Person.email2)
}
inline std::string* Person::mutable_email2() {
  // @@protoc_insertion_point(field_mutable:tutorial.Person.email2)
  return _internal_mutable_email2();
}
...
inline void Person::_internal_set_email2(const std::string& value) {
  ...
  email2_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Person::set_email2(std::string&& value) {
  
  email2_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:tutorial.Person.email2)
}
inline void Person::set_email2(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  email2_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tutorial.Person.email2)
}
inline void Person::set_email2(const char* value,
    size_t size) {
  
  email2_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:tutorial.Person.email2)
}
inline std::string* Person::_internal_mutable_email2() {
  
  return email2_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Person::release_email2() {
  // @@protoc_insertion_point(field_release:tutorial.Person.email2)
  return email2_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Person::set_allocated_email2(std::string* email2) {
  if (email2 != nullptr) {
    
  } else {
    
  }
  email2_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), email2,
      GetArena());
